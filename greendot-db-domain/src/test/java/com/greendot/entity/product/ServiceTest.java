...
public class ServiceTest {
    ...
    private Service lhs = buildBasicEntity();
    private Service rhs = buildBasicEntity();
    
    public static Service buildBasicEntity() {

        final Service good = new Service();
